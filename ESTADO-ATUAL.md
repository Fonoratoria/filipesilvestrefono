...
- **2026-06-28 — [Claude]** — ⚡ OTIMIZAÇÃO DE VELOCIDADE / UX (PageSpeed mobile estava
  ...
  app); decidido NÃO fazer agora. Estimativa: 79 → ~90+. **PUBLICADO em 2026-06-28
  (commit 540ee5d).** Revisão no ar OK: todas as páginas 200, fontes não-bloqueantes no ar,
  todas as imagens novas servindo, peso total caiu 1.551→819KB. O thumbnail YouTube
  `BBi3X4pvkqQ` dá 404 no maxres mas o fallback do site resolve p/ sddefault (capa válida).
